...
namespace Keystone.Abstractions
{
    ...
    /// that should inherit from the generic KeystoneApplicationManager class.
    ...
    /// </summary>
    public interface IKeystoneApplicationManager
    {
        /// <summary>
        ...
        /// </returns>
        Task<object> CreateAsync([NotNull] KeystoneApplicationDescriptor descriptor, CancellationToken cancellationToken = default);
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        Task PopulateAsync([NotNull] KeystoneApplicationDescriptor descriptor, [NotNull] object application, CancellationToken cancellationToken = default);
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        Task PopulateAsync([NotNull] object application, [NotNull] KeystoneApplicationDescriptor descriptor, CancellationToken cancellationToken = default);
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        Task UpdateAsync([NotNull] object application, [NotNull] KeystoneApplicationDescriptor descriptor, CancellationToken cancellationToken = default);
