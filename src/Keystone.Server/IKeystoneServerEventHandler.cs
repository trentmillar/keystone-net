...
namespace Keystone.Server
{
    ...
    public interface IKeystoneServerEventHandler<TEvent> where TEvent : class, IKeystoneServerEvent
    {
        /// <summary>
        /// Processes the event.
        /// </summary>
        ...
        /// </returns>
        Task<KeystoneServerEventState> HandleAsync([NotNull] TEvent notification);
    }
}
