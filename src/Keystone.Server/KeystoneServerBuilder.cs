...
{
    /// <summary>
    /// Exposes the necessary methods required to configure the Keystone server services.
    /// </summary>
    public class KeystoneServerBuilder
    {
        /// <summary>
        /// Initializes a new instance of <see cref="KeystoneServerBuilder"/>.
        /// </summary>
        /// <param name="services">The services collection.</param>
        public KeystoneServerBuilder([NotNull] IServiceCollection services)
        {
            if (services == null)
            {
        ...
        public KeystoneServerBuilder AddEventHandler<TEvent>(
            [NotNull] Func<TEvent, Task<KeystoneServerEventState>> handler)
            where TEvent : class, IKeystoneServerEvent
        {
            ...
            Services.AddSingleton<IKeystoneServerEventHandler<TEvent>>(
                new KeystoneServerEventHandler<TEvent>(handler));
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public KeystoneServerBuilder AddEventHandler<THandler>(ServiceLifetime lifetime = ServiceLifetime.Scoped)
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public KeystoneServerBuilder AddEventHandler([NotNull] Type type, ServiceLifetime lifetime = ServiceLifetime.Scoped)
        {
            if (type == null)
            {
            ...
            var services = KeystoneHelpers.FindGenericBaseTypes(type, typeof(IKeystoneServerEventHandler<>)).ToArray();
        ...
        /// <summary>
        /// Amends the default Keystone server configuration.
        /// </summary>
        /// <param name="configuration">The delegate used to configure the Keystone options.</param>
        /// <remarks>This extension can be safely called multiple times.</remarks>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder Configure([NotNull] Action<KeystoneServerOptions> configuration)
        {
            ...
            Services.Configure(KeystoneServerDefaults.AuthenticationScheme, configuration);
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AcceptAnonymousClients()
            => Configure(options => options.AcceptAnonymousClients = true);

        /// <summary>
        /// Registers (and generates if necessary) a user-specific development
        /// certificate used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddDevelopmentSigningCertificate()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddDevelopmentSigningCertificate([NotNull] X500DistinguishedName subject)
        {
            if (subject == null)
            {
        ...
        /// <summary>
        /// Registers a new ephemeral key used to sign the JWT tokens issued by Keystone: the key
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddEphemeralSigningKey()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddEphemeralSigningKey([NotNull] string algorithm)
        {
        ...
        /// <summary>
        /// Registers a <see cref="SecurityKey"/> used to encrypt the JWT access tokens issued by Keystone.
        /// </summary>
        /// <param name="key">The security key.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddEncryptingKey([NotNull] SecurityKey key)
        {
            if (key == null)
            {
        ...
        /// <summary>
        /// Registers a <see cref="X509Certificate2"/> that is used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <param name="certificate">The certificate used to sign the security tokens issued by the server.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddSigningCertificate([NotNull] X509Certificate2 certificate)
        {
            if (certificate == null)
            {
        ...
        /// embedded resource and used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <param name="assembly">The assembly containing the certificate.</param>
        /// <param name="resource">The name of the embedded resource.</param>
        /// <param name="password">The password used to open the certificate.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddSigningCertificate(
        ...
        /// stream and used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <param name="stream">The stream containing the certificate.</param>
        /// <param name="password">The password used to open the certificate.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddSigningCertificate([NotNull] Stream stream, [NotNull] string password)
        {
            if (stream == null)
            {
        ...
        /// machine store and used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <param name="thumbprint">The thumbprint of the certificate used to identify it in the X.509 store.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddSigningCertificate([NotNull] string thumbprint)
        {
        ...
        /// X.509 store and used to sign the JWT tokens issued by Keystone.
        /// </summary>
        /// <param name="thumbprint">The thumbprint of the certificate used to identify it in the X.509 store.</param>
        ...
        /// <summary>
        /// Registers a <see cref="SecurityKey"/> used to sign the JWT tokens issued by Keystone.
        /// Note: using <see cref="RsaSecurityKey"/> asymmetric keys is recommended on production.
        /// </summary>
        /// <param name="key">The security key.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AddSigningKey([NotNull] SecurityKey key)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowAuthorizationCodeFlow()
            => Configure(options => options.GrantTypes.Add(KeystoneConstants.GrantTypes.AuthorizationCode));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowClientCredentialsFlow()
            => Configure(options => options.GrantTypes.Add(KeystoneConstants.GrantTypes.ClientCredentials));
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowCustomFlow([NotNull] string type)
        {
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowImplicitFlow()
            => Configure(options => options.GrantTypes.Add(KeystoneConstants.GrantTypes.Implicit));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowPasswordFlow()
            => Configure(options => options.GrantTypes.Add(KeystoneConstants.GrantTypes.Password));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder AllowRefreshTokenFlow()
            => Configure(options => options.GrantTypes.Add(KeystoneConstants.GrantTypes.RefreshToken));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableAuthorizationStorage()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableConfigurationEndpoint()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableCryptographyEndpoint()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableHttpsRequirement()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableSlidingExpiration()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableTokenStorage()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableAuthorizationEndpoint(PathString path)
        {
            if (!path.HasValue)
            {
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableIntrospectionEndpoint(PathString path)
        {
            if (!path.HasValue)
            {
                throw new ArgumentException("The path cannot be empty.", nameof(path));
        ...
        /// <param name="path">The relative path of the logout endpoint.</param>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableLogoutEndpoint(PathString path)
        {
            if (!path.HasValue)
            {
                throw new ArgumentException("The path cannot be empty.", nameof(path));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableRequestCaching()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableRevocationEndpoint( PathString path)
        {
            if (!path.HasValue)
            {
                throw new ArgumentException("The path cannot be empty.", nameof(path));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder DisableScopeValidation()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableTokenEndpoint(PathString path)
        {
            if (!path.HasValue)
            {
                throw new ArgumentException("The path cannot be empty.", nameof(path));
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder EnableUserinfoEndpoint(PathString path)
        {
            if (!path.HasValue)
            {
                throw new ArgumentException("The path cannot be empty.", nameof(path));
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder IgnoreEndpointPermissions()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder IgnoreGrantTypePermissions()
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder IgnoreScopePermissions()
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder RegisterClaims([NotNull] params string[] claims)
        {
            if (claims == null)
            {
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder RegisterScopes([NotNull] params string[] scopes)
        {
            if (scopes == null)
            {
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetAccessTokenLifetime([CanBeNull] TimeSpan? lifetime)
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetAuthorizationCodeLifetime([CanBeNull] TimeSpan? lifetime)
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetIdentityTokenLifetime([CanBeNull] TimeSpan? lifetime)
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetRefreshTokenLifetime([CanBeNull] TimeSpan? lifetime)
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetRequestCachingPolicy([NotNull] DistributedCacheEntryOptions policy)
        {
            if (policy == null)
            {
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder SetIssuer([NotNull] Uri address)
        {
            if (address == null)
            {
        ...
        /// <summary>
        /// Configures Keystone to use a specific data protection provider
        ...
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder UseDataProtectionProvider([NotNull] IDataProtectionProvider provider)
        {
            if (provider == null)
            {
        ...
        /// Note: JWT tokens cannot be used with the Keystone validation handler.
        /// To validate JWT tokens, use the JWT handler shipping with ASP.NET Core.
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder UseJsonWebTokens()
        ...
        /// <summary>
        /// Configures Keystone to use reference tokens, so that authorization codes,
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder UseReferenceTokens()
            => Configure(options => options.UseReferenceTokens = true);

        /// <summary>
        /// Configures Keystone to use rolling refresh tokens. When this option is enabled,
        ...
        /// </summary>
        /// <returns>The <see cref="KeystoneServerBuilder"/>.</returns>
        public KeystoneServerBuilder UseRollingTokens()
