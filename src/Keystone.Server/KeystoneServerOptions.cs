...
{
    /// <summary>
    /// Provides various settings needed to configure the Keystone server handler.
    /// </summary>
    public class KeystoneServerOptions : OpenIdConnectServerOptions
    {
        /// <summary>
        /// Creates a new instance of the <see cref="KeystoneServerOptions"/> class.
        /// </summary>
        public KeystoneServerOptions()
        {
            Provider = null;
            ProviderType = typeof(KeystoneServerProvider);
        }
        ...
        /// <summary>
        /// Gets or sets the distributed cache used by Keystone. If no cache is explicitly
        ...
        {
            KeystoneConstants.Claims.Audience,
            KeystoneConstants.Claims.ExpiresAt,
            KeystoneConstants.Claims.IssuedAt,
            KeystoneConstants.Claims.Issuer,
            KeystoneConstants.Claims.JwtId,
            KeystoneConstants.Claims.Subject
        };
        ...
        {
            KeystoneConstants.Scopes.OpenId
        };
